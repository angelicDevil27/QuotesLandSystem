...
<html>
	...
	<body>
	<a href="logout.php"><button class="btn-primary" type="button">Log Out</button></a><br />
	Welcome <span style='font-size:50px'><?php echo $username;?></span>
			...
			<div id="getToKnow">
				...
				<form>				
						...
						<!--<input type="button" id="qbtn" value="POST"><br />-->
						<!----bootstrap button---->						
